...
class Program
{
    static void Main(string[] args)
    {
        ...
        //below: Board is the class in other file, board is instance, new Board creates a new class Board 
...
//COMMENTED OUT GETNEWBOARD FUNC BECAUSE IS NOW CONTAINED W/IN BOARD CLASS IN bOARD.CS
    // /// <summary>
